...
//    @Value("${secret:aaabbbcccdddeeefffggghhhiiijjjkkklllmmmnnnooopppqqqrrrsssttt}")
    private static final String secret = "aaabbbcccdddeeefffggghhhiiijjjkkklllmmmnnnooopppqqqrrrsssttt";
    /**
     * 有效期，单位秒
     * - 默认2周
     */
//    @Value("${expire-time-in-second:1209600}")
    private static final Long expirationTimeInSecond = 1L;
